...
public class FFAItemCocoaBeans extends FCItemFood
{
    ...
    public FFAItemCocoaBeans(int var1, int foodvalue, float fatvalue, boolean dogfood, String unlocalname)
    {
        super(var1, foodvalue, fatvalue, dogfood, unlocalname);
